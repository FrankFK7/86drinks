...
router.get("./views/cocktails", (req, res, next) => {
  axios.get("www.thecocktaildb.com/api/json/v1/1/search.php?s=")
  .then(responseFromAPI => {
     console.log(responseFromAPI)
     res.render("cocktails/list-cocktails", { cocktails: responseFromAPI.data });
    })
